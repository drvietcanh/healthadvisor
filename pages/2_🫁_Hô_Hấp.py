...
from respiratory_page_components import render_copd_tab, render_asthma_tab, render_pneumonia_tab
...
tab1, tab2, tab3 = st.tabs(["🫁 COPD (Phổi Tắc Nghẽn)", "🌬️ Hen Suyễn", "🫁 Viêm phổi"])
